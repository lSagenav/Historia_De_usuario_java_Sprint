...
@Data
@NoArgsConstructor
@Schema(description = "DTO de entrada para crear eventos. No expone ID interno, active ni estructura JPA.")
public class EventCreateDTO {
    @NotBlank(message = "no debe estar vacio")
    @Size(min = 3, max = 150, message = "debe tener entre 3 y 150 caracteres")
    @Schema(description = "Nombre publico del evento", example = "Concierto de ROCK", minLength = 3, maxLength = 150)
